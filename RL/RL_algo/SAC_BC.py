...
SelfSAC = TypeVar("SelfSAC", bound="SAC_BC")


class SAC_BC(OffPolicyAlgorithm):
    ...
    def __init__(
        ...
        ### Parameters for BC specifically
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            bc_loss = F.mse_loss(predicted_actions, demo_actions)*self.BC_coeff
            q_values_pi = th.cat(self.critic(replay_data.observations, actions_pi), dim=1)
            min_qf_pi, _ = th.min(q_values_pi, dim=1, keepdim=True)
            actor_loss = (ent_coef * log_prob - min_qf_pi + bc_loss).mean()
