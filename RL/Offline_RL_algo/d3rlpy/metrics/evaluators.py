...
from .utility import evaluate_qlearning_with_environment_dict
...
class EnvironmentEvaluator_dict(EvaluatorProtocol):
    r"""Action matches between algorithms.
    ...
    def __call__(
        ...
        return evaluate_qlearning_with_environment_dict(
            algo=algo,
            env=self._env,
            n_trials=self._n_trials,
            epsilon=self._epsilon,
